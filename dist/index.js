...
function processStringValue(value, prop, basePixelSize, customRegex = false) {
    ...
    let newValue = value;
    const match = do_mathRegex.exec(value);
 ...
 */
function processExpression(expression, prop, basePixelSize) {
    // Trim whitespace
